...
function update_wealth_counter() {
  if (bezos_viewable()) {
    if (bezos_counter_viewable()) {
      ...
      bezos_counter.innerHTML = (wealth < 185000000000) ? money.format(wealth) : "185,000,000,000kg";
    }
    else {
    ...
    if (four_hundred_counter_viewable()) {
      ...
      four_hundred_counter.innerHTML = (wealth < 3200000000000) ? money.format(wealth) : "3,200,000,000,000kg";
    }
    else {
